...
TARGET_FOLDERS = ["EDI Tasks"]  # Comment DevTasks for Now
...
def check_tasks():
    ...
    for folder_path in TARGET_FOLDERS:
        ...
        for task in tasks:
            ...
            # CASE 1: Task ran today before cutoff but failed
            ...
            # CASE 2: Task was scheduled for today but never ran
                ...
                html_rows.append(f"""
                    <tr>
                        ...
                        <td>{format_dt(last_run)}</td>
                        <td>{last_result_hex}</td>
                        <td><strong style='color:orange;'>Failed</strong></td>
                    </tr>
                """)
